...
class Route:
    def __init__(self, route_label=None, route_package_keys=None, route_package_table=None,
    ...
    def __str__(self):
        ...
        return (f"{line_format:_<400}\n \n{package_table}\n"
                ...
                f"{print_route_distances(self.route, len(self.route_distance_matrix[0]))}\n")